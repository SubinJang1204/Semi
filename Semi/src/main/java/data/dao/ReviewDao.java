...
public class ReviewDao {
	...
	public void insertSmart(ReviewDto dto) {
		Connection conn=db.getConnection();
		PreparedStatement pstmt=null;
		String sql="insert into reviewanswer (photo,writer, content,taste,delivery,smell,writeday) values(?,?,?,?,?,?,now())";
		...
		try {
			...
			pstmt.setInt(4, dto.getTaste());
			pstmt.setInt(5, dto.getDelivery());
			pstmt.setInt(6, dto.getSmell());
