...
<form action="event/updateaction.jsp" method="post" enctype="multipart/form-data">
	...
	<table class="table table-bordered" style="width: 850px;margin-left: 100px;">
		...
		<tr>
			<td colspan="2" align="center">
				...
				<button type="button" class="btn btn-warning"
					style="width: 120px;"
					onclick="location.href='index.jsp?main=event/smartlist.jsp?currentPage=<%=currentPage%>'">목록</button>
			</td>
		</tr>
