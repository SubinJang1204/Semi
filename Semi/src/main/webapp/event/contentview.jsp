...
$(function(){
	...
	$.ajax({
			...
			type:"get",
			url:"event/updateactionjson.jsp",
			dataType:"html",
			data:{"idx":idx,
				"nickname":nickname,
				"content":content
			...
			<tr>
				<td align="right" colspan="7">
					...
					<button type="button" class="btn btn-default"
						onclick="location.href='index.jsp?main=event/smartlist.jsp?currentPage=<%=currentPage%>'">
...
function funcdel(num,currentPage){
   ...
   if(a){
	   location.href="event/deleteaction.jsp?num="+num+"&currentPage="+currentPage;
   }
}
</script>
