...
<form action="manager/event/smartaction.jsp" method="post" enctype="multipart/form-data" style="margin-top:130px">
		...
		<tr>
			...
			<td>
				<input type="file" name="mainphoto" class="form-control"
					required="required" style="width: 210px;">
			</td>
		</tr>
		...
		<tr>
			<td colspan="2" align="center">
				<button type="button" class="btn btn-warning"
					style="width: 120px;background-color:#FF7BAC;border:none;color:#fff"
					onclick="submitContents(this)">DB저장</button>
				
				<button type="button" class="btn btn-default"
					style="width: 120px;"
					onclick="location.href='index.jsp?main=manager/event/smartlist.jsp'">목록</button>
			</td>
		</tr>
