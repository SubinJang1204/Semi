...
<table style="width: 1100px; height: 700px;" id="detail">
   <tr>
      <td>
         ...
         <h3 style="float: left; font-size: 30pt;">리뷰 평점</h3> 
      </td>
...
;" onclick="../index.jsp?main=shop/shoplist.jsp" id="btncart">바로구매</button>
...
<div class="tab-content" style="margin-top: 200px;">
  ...
  <div id="menu2" style="margin-top: 100px;">
   ...
   <div class="alert" style="width: 1300px; margin-left: 320px; margin-top: 50px; text-align: left;">
   	<h3>시크릿 티 스토리</h3>
...
$("#btncart").click(function(){
   ...
   $.ajax({
      type:"post",
      dataType:"html",
      url:"teashop/detailprocess.jsp",
      data:formdata,
      success:function(a){
         alert("success");
         if(a){
            location.href="index.jsp?main=teashop/mypart.jsp";
         }
      }
   });
});
